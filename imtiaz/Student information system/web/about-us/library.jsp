...
<tbody>
 <align="center" width="780">
            <tr><td colspan="3" width="295"> LIBRARY</td></tr>
          </tr>
          <tr>
          <td width="295" height="30">&nbsp; Book Issued Name</FONT>
...
<td colspan="3" width="295" height="25">&nbsp;    </td>
          ...
          <tr>
<td width="295" height="25">&nbsp; FINE </td>
         <td colspan="3">&nbsp; - - ( not returning of book on time ) </td>
          </tr>
          <tr>
          <td colspan="3" width="295"  height="25"><a href="#"><center> Books List</center></a></td></tr>	
          <tr>
          <td colspan="3" width="295"  height="25">&nbsp; Note : More than Two Book can not be issued to a student.</td>
          </tr>
