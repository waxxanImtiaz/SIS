...
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8236"><a href="#">Transport </a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8235"><a href="#">Points Route</a></li>
</ul>
</li>
		...
		<div id="container">
			<div id="content" role="main">
				...
				<div id="post-136" class="post-136 page type-page status-publish has-post-thumbnail hentry">
											<h1 class="entry-title">Personel Information</h1>
...
<tr>
<td>Father Name</td>
<td><%=personalInfo.getFatherName()%></td>
</tr>
<tr>
<td>Department</td>
<td><%=personalInfo.getDepartment()%></td>
</tr>
<tr>
<td>Caste</td>
...
<tr>
<td>Address</td>
<td><%=personalInfo.getTempAdd()%></td>
</tr>
<tr>
<td>Permanent Address</td>
<td><%=personalInfo.getPermAdd()%></td>
</tr>
<tr>
<td>Gender</td>
<td><%=personalInfo.getGender()%></td>
</tr>
<tr>
<td>Contact</td>
<td><%=personalInfo.getStContactNum()%></td>
</tr>
<tr>
